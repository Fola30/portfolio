...
import Img from "../images/contactImg.png"
                ...
                <div className="info-container">
                    <div className="info">
                        ...
                        <div className="details-container">
                            ...
                            <h5 className="detail">kazeemrasheed3063@gmail.com</h5>
                        </div>
                    </div>
                    <div className="info">
                        <div className="icon-container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone-x-fill" viewBox="0 0 16 16">
                        ...
                        <div className="details-container">
                            ...
                            <h5 className="detail">+234 9029313376</h5>
                        </div>
                    </div>
                </div>
            </div>
